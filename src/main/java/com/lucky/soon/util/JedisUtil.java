...
import com.lucky.soon.common.RedisConstant;
import com.lucky.soon.common.SerializableUtil;
import com.lucky.soon.exception.CustomException;
...
public class JedisUtil {
	 ...
	 */
	public static String setLock(String key, String value, int expiretime) {
		String result;
		try (Jedis jedis = jedisPool.getResource()) {
			result = jedis.set(key, value, RedisConstant.NX, RedisConstant.PX, expiretime);
			return result;
		} catch (Exception e) {
			throw new CustomException("lock:key=" + key + e.getMessage());
		}
	}
